...
class Thread {
  ...
  public:
    ...
    void update_approx_burst_time();
    void setStatus(ThreadStatus st); // mp3
    ...
    float burst_start_time, approx_burst_time, accumulated_ticks;
    float last_accumulated_ticks;

    int priority;  
    int wait_tick;  
    void add_priority(int x);  // mp3
