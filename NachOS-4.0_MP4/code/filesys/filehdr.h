...
//MP4 IM
#define NumDirect ((SectorSize - (2+1) * sizeof(int)) / sizeof(int))
#define MaxFileSize (NumDirect * SectorSize) //Trace code
...
public:
	// MP4 mod tag
	FileHeader(bool firstf); // dummy constructor to keep valgrind happy
	~FileHeader();
