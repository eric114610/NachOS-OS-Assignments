...
public:
    ...
    bool Remove(char *name, bool recursive); // Remove a file from the directory

    void List(bool recursive, int Le);  // Print the names of all the files
                  //  in the directory
    void Print(); // Verbose print of the contents
                  //  of the directory -- all the file
                  //  names and their contents.
    //MP4 IM
    void RemoveAll(OpenFile* dirFile);
